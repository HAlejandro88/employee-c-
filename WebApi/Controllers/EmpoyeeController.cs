...
namespace WebApi.Controllers
{
    ...
    public class EmpoyeeController : ControllerBase
    {
        ...
        public EmpoyeeController(IConfiguration configuration, IWebHostEnvironment env)
        {
        ...
        public JsonResult Put(Employee emp)
        {
            string query = @"update dbo.Employee set 
                            EmployeName = '" + emp.EmpoyeeName + @"',
                            Department = '" + emp.Department + @"'
                            DateOfJoining = '" + emp.DateOfJoining + @"'
                            PhotoFileName = '" + emp.PhotoFileName + @"'
                            where DepartmentId = " + emp.EmpoyeeId + @" ";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("EmployeeAppCon");// traigo la conexion de SQL
            SqlDataReader myReader;
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
        ...
        public JsonResult SaveFile()
        {
            try {
                ...
                return new JsonResult("anoyumous.png");
            }
